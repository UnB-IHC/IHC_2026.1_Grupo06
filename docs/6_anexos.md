# <img src="imagens/folder.png" alt="" width="32" style="vertical-align: middle; margin-right: 8px;"> 6. Anexos

<p style="text-align: justify;">Esta seção reúne os artefatos e documentos técnicos produzidos e consolidados ao longo de toda a pesquisa de IHC. Os arquivos foram organizados de forma a comprovar e documentar o processo de auditoria por especialistas e os testes empíricos de usabilidade realizados.</p>
