...
<table style="width: 100%; border-collapse: collapse; text-align: justify; margin-top: 15px;">
  ...
  <tbody>
    <tr>
      <td style="border: 1px solid #dddddd; padding: 8px; vertical-align: top;"><strong><a href="videos/cenario1.mp4" style="text-decoration: underline; color: #007bff;">Cenário 1:<br>Contato</a></strong></td>
    ...
    <tr>
      <td style="border: 1px solid #dddddd; padding: 8px; vertical-align: top;"><strong><a href="videos/cenario2.mp4" style="text-decoration: underline; color: #007bff;">Cenário 2:<br>Agendamento</a></strong></td>
    ...
    <tr>
      <td style="border: 1px solid #dddddd; padding: 8px; vertical-align: top;"><strong><a href="videos/cenario3.mp4" style="text-decoration: underline; color: #007bff;">Cenário 3:<br>Autenticação</a></strong></td>
    ...
    <tr>
      <td style="border: 1px solid #dddddd; padding: 8px; vertical-align: top;"><strong><a href="videos/cenario4.mp4" style="text-decoration: underline; color: #007bff;">Cenário 4:<br>Acessibilidade</a></strong></td>
...
<p style="text-align: justify; padding: 12px; border-left: 4px solid #007bff; margin-top: 15px; margin-bottom: 15px;">
   <strong>Nota de Documentação:</strong> O relatório analítico completo, contendo os roteiros e apêndices desta entrevista, bem como os <strong>vídeos gravados de cada cenário de teste</strong>, e o <strong>vídeo na íntegra</strong> encontram-se disponíveis para consulta e download na seção de <a href="6_anexos.html">Anexos (Relatório de Usabilidade e Vídeos da Entrevista)</a>
</p>
